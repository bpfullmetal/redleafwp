...
function initPano2vr() {
  ...
  var pano = new pano2vrPlayer("container"); // load the configuration

  pano.on("imagesready", function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ggskin_image').fadeOut(200);
    setTimeout(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#loaderStep1').addClass('pano-loaded');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#loaderStep1 .loader-wrapper').append(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#loaderStep0 .loader-container')).fadeIn(200);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#loaderStep0').hide(); // $('.ggskin_image').fadeIn(200)
    }, 200);
  });
  window.addEventListener("load", function () {
    pano.readConfigUrlAsync(virtualTourData.xml);
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('div.ggskin_image').append(jquery__WEBPACK_IMPORTED_MODULE_0___default()('.loader-container'));

  if (window.navigator.userAgent.match(/Safari/i)) {
    // fix for white borders, rotation on iPhone
    var iosHfix = function iosHfix(e) {
      window.scrollTo(0, 1);
      ...
      if (oh != container.offsetHeight) {
        ...
        var topOffset = jquery__WEBPACK_IMPORTED_MODULE_0___default()(container).offset().top * -1;
    ...
    window.addEventListener("resize", function () {
      setTimeout(iosHfix, 0); // hide toolbar on iPad happens with a delay
...
window.addEventListener('load', function () {
  ...
  playButton.addEventListener('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(loaderStep2).fadeOut(1000);
    hideInstructions();
  });
...
var messageHandler = function messageHandler(event) {
  ...
  switch (event.data.type) {
    ...
    case "stage1_inqueued":
      ...
      loaderStep1.style.visibility = "visible"; // Show the header
    ...
    case "stage4_playBtnShowedUp":
      ...
      iFrame.style.visibility = "visible"; // If switching iframe src, don't show loaders again

      if (isReloadingIframe) return;
      loaderStep3.style.visibility = "visible"; // let playButton = document.getElementById("playButtonParent");
      // playButton.click();
      // onPlayBtnPressed();
    ...
    case "stage5_playBtnPressed":
      ...
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(resetIframeLoader).is(':visible')) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(resetIframeLoader).fadeOut();
      }

      jquery__WEBPACK_IMPORTED_MODULE_0___default()(iFrame).focus(); // If switching iframe src, don't show loaders again
      ...
      showInstructions(); // Show the play button
...
var switchIframe = function switchIframe(layout, referrer) {
  if (referrer === 'resize') {
...
var onPlayBtnPressed = function onPlayBtnPressed() {
  loaderStep2.style.visibility = "hidden";
...
/******/ })()
;
//# sourceMappingURL=virtualtour.js.map